...
typedef int8_t (*dio59020_read_func_t)(uint8_t address, uint8_t reg, uint8_t* data, uint16_t size);
typedef int8_t (*dio59020_write_func_t)(uint8_t address, uint8_t reg, uint8_t* data, uint16_t size);
